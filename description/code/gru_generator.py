...
model = load_model('/Users/hongseongmi/Documents/git_ws/Yooninahong/description/senten_generating_model3.h5')

# load vec ID
with open('/Users/hongseongmi/Documents/git_ws/Yooninahong/description/data/char2idx3.pickle', 'rb') as fr:
